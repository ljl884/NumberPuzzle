...
void Move::doMove()
{
	...
	{
	case UP:
		moveableNumber->runAction(MoveBy::create(MOVE_DURATION, Point(0, Constant::Y_ALIGN)));
		break;
	case DOWN:
		moveableNumber->runAction(MoveBy::create(MOVE_DURATION, Point(0, 0 - Constant::Y_ALIGN)));
		break;
	case LEFT:
		moveableNumber->runAction(MoveBy::create(MOVE_DURATION, Point(0 - Constant::X_ALIGN, 0)));
		break;
	case RIGHT:
		moveableNumber->runAction(MoveBy::create(MOVE_DURATION, Point(Constant::X_ALIGN, 0)));
		break;
	default:
		return;
	}
